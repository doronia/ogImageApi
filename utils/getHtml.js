           ...
           <head>
            ...
            <style> 
                 ...
                 *:after { box-sizing: border-box; } 
                 ...
                 h1 { font-size: 72px; line-height: 1.2; color: #1E1E1C; margin: 0; text-align: right; } 
                 ...
                 .shadow{
                     -webkit-box-shadow: -${shadowWidth}px ${shadowWidth}px 0 0 rgba(0,0,0,0.75);
                     -moz-box-shadow: -${shadowWidth}px ${shadowWidth}px 0 0 rgba(0,0,0,0.75);
                     box-shadow: -${shadowWidth}px ${shadowWidth}px 0 0 rgba(0,0,0,0.75);
                 }
                 .tag {
                     color: #651fff;
                     font-size: 32px;
